#!/usr/bin/env python3
"""
PerimeterControl Rules Generator

Reads config file and generates:
    - hostapd.conf (WiFi AP configuration)
    - dnsmasq.conf (DHCP/DNS configuration)
    - perimetercontrol.nft (nftables firewall rules)

Usage:
        python3 apply-rules.py --config /path/to/perimetercontrol.conf.yaml
"""
...
import os
PERIMETERCONTROL_CONF_NAME = os.environ.get('PERIMETERCONTROL_CONF_NAME', 'perimetercontrol.conf.yaml')
PERIMETERCONTROL_NFT_NAME = os.environ.get('PERIMETERCONTROL_NFT_NAME', 'perimetercontrol.nft')
PERIMETERCONTROL_DOMAIN = os.environ.get('PERIMETERCONTROL_DOMAIN', 'perimetercontrol.local')
PERIMETERCONTROL_LOG_DIR = os.environ.get('PERIMETERCONTROL_LOG_DIR', '/var/log/PerimeterControl')
PERIMETERCONTROL_ETC_DIR = os.environ.get('PERIMETERCONTROL_ETC_DIR', '/etc/PerimeterControl')
PERIMETERCONTROL_TEMPLATES_DIR = os.environ.get('PERIMETERCONTROL_TEMPLATES_DIR', '/opt/PerimeterControl/templates')
PERIMETERCONTROL_HOSTAPD_CONF = os.environ.get('PERIMETERCONTROL_HOSTAPD_CONF', '/etc/hostapd/hostapd.conf')
PERIMETERCONTROL_DNSMASQ_CONF = os.environ.get('PERIMETERCONTROL_DNSMASQ_CONF', '/etc/dnsmasq.d/perimetercontrol.conf')
...
class RulesGenerator:
    """Generates configuration files from config file (PerimeterControl)"""
    ...
    def generate_hostapd(self):
        ...
        hostapd_conf = f"""# hostapd configuration - Generated by PerimeterControl
    ...
    # AP Identity
    ssid={ap_config.get('ssid', 'PerimeterControl')}
    ...
    """
        ...
        system_file = Path(PERIMETERCONTROL_HOSTAPD_CONF)
    ...
    def generate_dnsmasq(self):
        ...
        dnsmasq_conf = f"""# dnsmasq configuration - Generated by PerimeterControl
    # DO NOT EDIT MANUALLY - Changes will be overwritten
    ...
    # DNS configuration
    domain={PERIMETERCONTROL_DOMAIN}
    local=/{PERIMETERCONTROL_DOMAIN}/

    # Logging
    log-queries
    log-dhcp
    log-facility={PERIMETERCONTROL_LOG_DIR}/dnsmasq.log
    ...
    """
        ...
        # Link to system location
        system_file = Path(PERIMETERCONTROL_DNSMASQ_CONF)
    ...
    # nftables ruleset - Generated by PerimeterControl
    # DO NOT EDIT MANUALLY - Changes will be overwritten
...
"""
        ...
        output_file = self.output_dir / PERIMETERCONTROL_NFT_NAME
        output_file.write_text(nft_rules)
        output_file.chmod(0o755)
        logger.info(f"Generated {PERIMETERCONTROL_NFT_NAME}")
...
def main():
    parser = argparse.ArgumentParser(description='Generate PerimeterControl configuration')
    parser.add_argument('--config', required=True, help=f'Path to {PERIMETERCONTROL_CONF_NAME}')
    parser.add_argument('--output-dir', default=PERIMETERCONTROL_ETC_DIR, help='Output directory for generated configs')
    parser.add_argument('--templates-dir', default=PERIMETERCONTROL_TEMPLATES_DIR, help='Templates directory')
