...
def create_service_status_panel(service_name: str, log_dir: str = "/var/log/PerimeterControl",
    ...
    def _get_style_div() -> Div:
        ...
        # Removed runtime padding adjuster: this was a client-side workaround
        # for header/content overlap. Prefer fixing source CSS/templates so
        # the document participates in normal flow instead of relying on JS.
        script_html = ""
