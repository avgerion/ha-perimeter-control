...
${this.error.stack||"No stack trace available"}</pre>
  ...
  `}),e([he({type:Array})],je.prototype,"nodes",void 0),e([he({type:Boolean})],je.prototype,"autoRefresh",void 0),e([he({type:Number})],je.prototype,"refreshInterval",void 0),e([ue()],je.prototype,"selectedNode",void 0),e([ue()],je.prototype,"selectedService",void 0),e([ue()],je.prototype,"loading",void 0),e([ue()],je.prototype,"error",void 0),je=e([de("perimeter-control-fleet-view")],je);let Ue=class extends je{};Ue=e([de("isolator-fleet-view")],Ue);let Ie=class extends ne{constructor(){super(...arguments),Object.defineProperty(this,"hass",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"config",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"_deploying",{enumerable:!0,configurable:!0,writable:!0,value:!1}),Object.defineProperty(this,"_error",{enumerable:!0,configurable:!0,writable:!0,value:""}),Object.defineProperty(this,"_log",{enumerable:!0,configurable:!0,writable:!0,value:[]}),Object.defineProperty(this,"_dashboardActive",{enumerable:!0,configurable:!0,writable:!0,value:null}),Object.defineProperty(this,"_supervisorActive",{enumerable:!0,configurable:!0,writable:!0,value:null}),Object.defineProperty(this,"_pollTimer",{enumerable:!0,configurable:!0,writable:!0,value:null})}disconnectedCallback(){super.disconnectedCallback(),this._stopPolling()}_apiBase(){return"/api/perimeter_control"}async _fetchAuth(e,t){const i=this.hass?.auth?.data?.access_token??"";return fetch(e,{...t,headers:{Authorization:`Bearer ${i}`,"Content-Type":"application/json",...t?.headers??{}}})}async _onDeploy(){const e=this.config?.entryId;if(this.hass)if(e){this._error="",this._log=[],this._deploying=!0;try{const t=await this._fetchAuth(`${this._apiBase()}/${e}/deploy`,{method:"POST"});if(!t.ok){const e=await t.json().catch(()=>({}));return this._error=e.message??`Deploy request failed (${t.status})`,void(this._deploying=!1)}this._startPolling(e)}catch(e){this._error=`Network error: ${e?.message??String(e)}`,this._deploying=!1}}else this._error="entry_id not configured. Add entry_id to the card YAML (find it on the device page in Settings → Devices).";else this._error="No Home Assistant context available."}_startPolling(e){this._stopPolling(),this._pollTimer=setInterval(()=>this._poll(e),1500)}_stopPolling(){null!==this._pollTimer&&(clearInterval(this._pollTimer),this._pollTimer=null)}async _poll(e){try{const t=await this._fetchAuth(`${this._apiBase()}/${e}/status`);if(!t.ok)return;const i=await t.json();this._log=i.deploy_log,this._dashboardActive=i.dashboard_active,this._supervisorActive=i.supervisor_active,i.deploy_in_progress||(this._deploying=!1,this._stopPolling())}catch{}}render(){const e=this.config?.piHost??"Pi",t=this.config?.services??[],i=Boolean(this.config?.entryId),r=this._log[this._log.length-1],o=r?.percent??0,s=this._log.some(e=>e.error)||Boolean(this._error);return F`
    ...
    `}getPerimeterControlDevices(){const e=Object.values(this.hass?.entities||{}),t=e.filter(e=>e.entity_id.startsWith("sensor.perimeter_control_")||e.entity_id.startsWith("binary_sensor.perimeter_control_")||e.entity_id.startsWith("button.perimeter_control_")||e.entity_id.startsWith("camera.perimeter_control_"));if(0===t.length){const t=e.filter(e=>{const t=e.entity_id;return t.includes("photo_booth")||t.includes("wildlife_monitor")||t.includes("camera")||t.includes("dashboard")});if(t.length>0)return[{name:"Perimeter Control Node",host:"192.168.50.47",entities:t,status:this.getDeviceStatus(t)}]}const i={};return t.forEach(e=>{const t=e.entity_id.split("_");if(t.length>3){const r=t.slice(2,-1).join("_");i[r]||(i[r]=[]),i[r].push(e)}}),Object.entries(i).map(([e,t])=>({name:e,host:t[0]?.attributes?.host||e,entities:t,status:this.getDeviceStatus(t)}))}getDeviceStatus(e){const t=e.some(e=>e.entity_id.includes("connected")&&"on"===e.state);return t?"connected":"disconnected"}renderNoDevices(){return F`
              ...
              ${e.host?F`
                <div class="service-card">
                  ...
                  <div style="margin-top: 8px;">
                    <button 
                      class="action-btn" 
                      @click=${()=>this.openDashboard(e.host,8080)}
                    ...
                    <button 
                      ...
                      @click=${()=>this.openDashboard(e.host,3e3)}
    ...
    `}getServiceName(e){return e.attributes?.friendly_name||e.entity_id.split(".")[1].replace(/_/g," ")}getServiceStatus(e){return e.entity_id.includes("sensor")?"unknown"!==e.state?e.state:"unknown":e.entity_id.includes("binary_sensor")?"on"===e.state?"active":"inactive":e.entity_id.includes("camera")?"unavailable"!==e.state?"active":"inactive":e.state||"unknown"}renderEntityActions(e){return e.entity_id.includes("button")?F`
                <div style="margin-top: 8px;">
                    <button 
                        class="action-btn" 
                        @click=${()=>this.callEntityService(e.entity_id,"press")}
                        style="padding: 6px 12px; font-size: 12px;"
                    >
                        Press ${this.getServiceName(e)}
                    </button>
                </div>
            `:e.entity_id.includes("camera")?F`
                <div style="margin-top: 8px;">
                    <button 
                        class="action-btn secondary" 
                        @click=${()=>this.showCameraEntity(e.entity_id)}
                        style="padding: 6px 12px; font-size: 12px;"
                    >
                        📷 View Camera
                    </button>
                </div>
            `:""}openDashboard(e,t){const i=`http://${e}:${t}`;window.open(i,"_blank")}async callEntityService(e,t){try{const i=e.split(".")[0];await(this.hass?.callService(i,t,{entity_id:e}))}catch(i){console.error(`Failed to call ${t} on ${e}:`,i)}}showCameraEntity(e){const t=new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0});this.dispatchEvent(t)}async deployAll(){try{await(this.hass?.callService("perimeter_control","deploy",{force:!0}))}catch(e){console.error("Deploy failed:",e)}}async reloadConfig(){try{await(this.hass?.callService("perimeter_control","reload_config",{}))}catch(e){console.error("Reload config failed:",e)}}async getDeviceInfo(){try{await(this.hass?.callService("perimeter_control","get_device_info",{}))}catch(e){console.error("Get device info failed:",e)}}};Object.defineProperty(Me,"styles",{enumerable:!0,configurable:!0,writable:!0,value:a`
    :host {
      display: block;
      padding: 16px;
      max-width: 1200px;
