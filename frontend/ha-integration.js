...
${this.error.stack||"No stack trace available"}</pre>
  ...
  `}),e([he({type:String})],me.prototype,"apiBaseUrl",void 0),e([he({type:String})],me.prototype,"serviceId",void 0),e([he({type:Object})],me.prototype,"service",void 0),e([ue()],me.prototype,"accessProfile",void 0),e([ue()],me.prototype,"loading",void 0),e([ue()],me.prototype,"saving",void 0),e([ue()],me.prototype,"error",void 0),e([ue()],me.prototype,"successMessage",void 0),me=e([de("perimeter-control-service-access-editor")],me);let ye=class extends me{};ye=e([de("isolator-service-access-editor")],ye);const xe=2;let $e=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};const{I:_e}=oe,we=e=>e,Ae=()=>document.createComment(""),ke=(e,t,r)=>{const i=e._$AA.parentNode,o=void 0===t?e._$AB:t._$AA;if(void 0===r){const t=i.insertBefore(Ae(),o),s=i.insertBefore(Ae(),o);r=new _e(t,s,e,e.options)}else{const t=r._$AB.nextSibling,s=r._$AM,a=s!==e;if(a){let t;r._$AQ?.(e),r._$AM=e,void 0!==r._$AP&&(t=e._$AU)!==s._$AU&&r._$AP(t)}if(t!==o||a){let e=r._$AA;for(;e!==t;){const t=we(e).nextSibling;we(i).insertBefore(e,o),e=t}}}return r},Pe=(e,t,r=e)=>(e._$AI(t,r),e),Se={},Ce=(e,t=Se)=>e._$AH=t,Ee=e=>{e._$AR(),e._$AA.remove()},Oe=(e,t,r)=>{const i=new Map;for(let o=t;o<=r;o++)i.set(e[o],o);return i},Te=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends $e{constructor(e){if(super(e),e.type!==xe)throw Error("repeat() can only be used in text expressions")}dt(e,t,r){let i;void 0===r?r=t:void 0!==t&&(i=t);const o=[],s=[];let a=0;for(const t of e)o[a]=i?i(t,a):a,s[a]=r(t,a),a++;return{values:s,keys:o}}render(e,t,r){return this.dt(e,t,r).values}update(e,[t,r,i]){const o=(e=>e._$AH)(e),{values:s,keys:a}=this.dt(t,r,i);if(!Array.isArray(o))return this.ut=a,s;const n=this.ut??=[],l=[];let d,c,p=0,h=o.length-1,u=0,f=s.length-1;for(;p<=h&&u<=f;)if(null===o[p])p++;else if(null===o[h])h--;else if(n[p]===a[u])l[u]=Pe(o[p],s[u]),p++,u++;else if(n[h]===a[f])l[f]=Pe(o[h],s[f]),h--,f--;else if(n[p]===a[f])l[f]=Pe(o[p],s[f]),ke(e,l[f+1],o[p]),p++,f--;else if(n[h]===a[u])l[u]=Pe(o[h],s[u]),ke(e,o[p],o[h]),h--,u++;else if(void 0===d&&(d=Oe(a,u,f),c=Oe(n,p,h)),d.has(n[p]))if(d.has(n[h])){const t=c.get(a[u]),r=void 0!==t?o[t]:null;if(null===r){const t=ke(e,o[p]);Pe(t,s[u]),l[u]=t}else l[u]=Pe(r,s[u]),ke(e,o[p],r),o[t]=null;u++}else Ee(o[h]),h--;else Ee(o[p]),p++;for(;u<=f;){const t=ke(e,l[f+1]);Pe(t,s[u]),l[u++]=t}for(;p<=h;){const e=o[p++];null!==e&&Ee(e)}return this.ut=a,Ce(e,l),q}});let Ue=class extends ne{constructor(){super(...arguments),Object.defineProperty(this,"nodes",{enumerable:!0,configurable:!0,writable:!0,value:[]}),Object.defineProperty(this,"autoRefresh",{enumerable:!0,configurable:!0,writable:!0,value:!0}),Object.defineProperty(this,"refreshInterval",{enumerable:!0,configurable:!0,writable:!0,value:3e4}),Object.defineProperty(this,"selectedNode",{enumerable:!0,configurable:!0,writable:!0,value:null}),Object.defineProperty(this,"selectedService",{enumerable:!0,configurable:!0,writable:!0,value:null}),Object.defineProperty(this,"loading",{enumerable:!0,configurable:!0,writable:!0,value:!1}),Object.defineProperty(this,"error",{enumerable:!0,configurable:!0,writable:!0,value:null}),Object.defineProperty(this,"refreshTimer",{enumerable:!0,configurable:!0,writable:!0,value:void 0})}connectedCallback(){super.connectedCallback(),this.autoRefresh&&this.startAutoRefresh()}disconnectedCallback(){super.disconnectedCallback(),this.stopAutoRefresh()}startAutoRefresh(){this.refreshTimer=window.setInterval(()=>{this.refreshAllNodes()},this.refreshInterval)}stopAutoRefresh(){this.refreshTimer&&clearInterval(this.refreshTimer)}async refreshAllNodes(){for(const e of this.nodes)await this.loadNodeFeatures(e),await this.loadNodeServices(e)}async loadNodeFeatures(e){try{e.status="connecting";const t=await fetch(`${e.url}/api/v1/node/features?timeout=10`);if(!t.ok)throw new Error(`HTTP ${t.status}`);const r=await t.json();e.features=r.node_features,e.status="online",e.lastUpdate=Date.now(),e.error=void 0}catch(t){e.status="offline",e.error=t instanceof Error?t.message:"Unknown error"}this.requestUpdate()}async loadNodeServices(e){try{const t=await fetch(`${e.url}/api/v1/services?timeout=5`);if(!t.ok)throw new Error(`HTTP ${t.status}`);const r=await t.json();e.services=r.services||[]}catch(t){e.services=[]}this.requestUpdate()}selectNode(e){this.selectedNode=e,this.selectedService=null}selectService(e){this.selectedService=e}render(){return F`
    ...
    `:F`<div class="placeholder">Loading services...</div>`}};Object.defineProperty(Ue,"styles",{enumerable:!0,configurable:!0,writable:!0,value:a`
    :host {
      display: block;
  ...
  `}),e([he({type:Array})],Ue.prototype,"nodes",void 0),e([he({type:Boolean})],Ue.prototype,"autoRefresh",void 0),e([he({type:Number})],Ue.prototype,"refreshInterval",void 0),e([ue()],Ue.prototype,"selectedNode",void 0),e([ue()],Ue.prototype,"selectedService",void 0),e([ue()],Ue.prototype,"loading",void 0),e([ue()],Ue.prototype,"error",void 0),Ue=e([de("perimeter-control-fleet-view")],Ue);let je=class extends Ue{};je=e([de("isolator-fleet-view")],je);let Ie=class extends ne{constructor(){super(...arguments),Object.defineProperty(this,"hass",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"config",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"_deploying",{enumerable:!0,configurable:!0,writable:!0,value:!1}),Object.defineProperty(this,"_error",{enumerable:!0,configurable:!0,writable:!0,value:""}),Object.defineProperty(this,"_log",{enumerable:!0,configurable:!0,writable:!0,value:[]}),Object.defineProperty(this,"_dashboardActive",{enumerable:!0,configurable:!0,writable:!0,value:null}),Object.defineProperty(this,"_supervisorActive",{enumerable:!0,configurable:!0,writable:!0,value:null}),Object.defineProperty(this,"_pollTimer",{enumerable:!0,configurable:!0,writable:!0,value:null})}disconnectedCallback(){super.disconnectedCallback(),this._stopPolling()}_apiBase(){return"/api/perimeter_control"}async _fetchAuth(e,t){const r=this.hass?.auth?.data?.access_token??"";return fetch(e,{...t,headers:{Authorization:`Bearer ${r}`,"Content-Type":"application/json",...t?.headers??{}}})}async _onDeploy(){const e=this.config?.entryId;if(this.hass)if(e){this._error="",this._log=[],this._deploying=!0;try{const t=await this._fetchAuth(`${this._apiBase()}/${e}/deploy`,{method:"POST"});if(!t.ok){const e=await t.json().catch(()=>({}));return this._error=e.message??`Deploy request failed (${t.status})`,void(this._deploying=!1)}this._startPolling(e)}catch(e){this._error=`Network error: ${e?.message??String(e)}`,this._deploying=!1}}else this._error="entry_id not configured. Add entry_id to the card YAML (find it on the device page in Settings → Devices).";else this._error="No Home Assistant context available."}_startPolling(e){this._stopPolling(),this._pollTimer=setInterval(()=>this._poll(e),1500)}_stopPolling(){null!==this._pollTimer&&(clearInterval(this._pollTimer),this._pollTimer=null)}async _poll(e){try{const t=await this._fetchAuth(`${this._apiBase()}/${e}/status`);if(!t.ok)return;const r=await t.json();this._log=r.deploy_log,this._dashboardActive=r.dashboard_active,this._supervisorActive=r.supervisor_active,r.deploy_in_progress||(this._deploying=!1,this._stopPolling())}catch{}}render(){const e=this.config?.piHost??"Pi",t=this.config?.services??[],r=Boolean(this.config?.entryId),i=this._log[this._log.length-1],o=i?.percent??0,s=this._log.some(e=>e.error)||Boolean(this._error);return F`
    ...
    `}),e([he({attribute:!1})],Ie.prototype,"hass",void 0),e([he({attribute:!1})],Ie.prototype,"config",void 0),e([ue()],Ie.prototype,"_deploying",void 0),e([ue()],Ie.prototype,"_error",void 0),e([ue()],Ie.prototype,"_log",void 0),e([ue()],Ie.prototype,"_dashboardActive",void 0),e([ue()],Ie.prototype,"_supervisorActive",void 0),Ie=e([de("perimeter-control-deploy-panel")],Ie);let Ne=class extends Ie{};Ne=e([de("isolator-deploy-panel")],Ne);let Re=class extends ne{constructor(){super(...arguments),Object.defineProperty(this,"hass",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"config",{enumerable:!0,configurable:!0,writable:!0,value:void 0})}setConfig(e){if(!e.service_id&&!e.show_deploy_panel)throw new Error("service_id is required unless show_deploy_panel is true");this.config=e}getConfigElement(){return F`
    ...
    `}static getStubConfig(){return{type:"custom:perimeter-control-card",service_id:"photo_booth",api_base_url:"http://localhost:8080"}}render(){if(!this.config)return F`<div>Configure this card</div>`;const e=this.config.api_base_url||"http://localhost:8080",t=this.config.api_timeout_ms||1e4,r=this.config.enable_error_details||!1,i=this.config.show_deploy_panel||!1,o=Boolean(this.config.service_id);return F`
      ...
      `}
    `}};e([he({attribute:!1})],Re.prototype,"hass",void 0),e([he({attribute:!1})],Re.prototype,"config",void 0),Re=e([de("perimeter-control-card")],Re);let ze=class extends Re{};ze=e([de("isolator-service-access-card")],ze),window.customCards=window.customCards||[],window.customCards.push({type:"perimeter-control-card",name:"Perimeter Control",description:"Control Isolator edge node access, fleet state, and deploy operations",preview:!1,documentationURL:"https://github.com/isolator/isolator#ha-integration"}),window.customCards.push({type:"isolator-service-access-card",name:"Perimeter Control (Legacy Type Alias)",description:"Backward-compatible alias. Prefer custom:perimeter-control-card.",preview:!1,documentationURL:"https://github.com/isolator/isolator#ha-integration"});export{Ie as DeployPanel,fe as ErrorBoundary,Ue as FleetView,ve as SafeLoader,Re as ServiceAccessCard,me as ServiceAccessEditor};
